  ...
  if (req.taskType === "review_question") {
    return {
      system: [
        ...
        "评价任何一段发言前，先看它的发言顺位和说话当时桌面上已公开的信息量：首位发言者前面无人开口、无对跳可站边、无发言可排坑，只要求捋昨晚结果、表态、给全场开个头，不能拿中后置位「站边/排狼坑/归票」的标准苛责他；同理，末位发言者才背归票的责任。",
        "复盘批评只能基于「当事人当时视角能推出的信息」，不许拿事后才揭示的真相开天眼倒推；确定的事实和你的行为推断要分开表述，别把推断说成定论。",
